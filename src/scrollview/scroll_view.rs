...
//         assert_eq!(
//             buf,
//             Buffer::with_lines(vec!["44444▲", "55555║", "66666█", "77777█", "88888█", "99999▼",])
//         )
//     }
//
//     #[rstest]
...
//         assert_eq!(
//             buf,
//             Buffer::with_lines(vec!["ABCDE▲", "KLMNO█", "UVWXY║", "EFGHI║", "OPQRS▼", "◄█══► ",])
//         )
//     }
//
//     #[rstest]
...
//         assert_eq!(
//             buf,
//             Buffer::with_lines(vec!["DEFGH▲", "NOPQR█", "XYZAB║", "HIJKL║", "RSTUV▼", "◄═█═► ",])
//         )
//     }
//
//     #[rstest]
...
//         assert_eq!(
//             buf,
//             Buffer::with_lines(vec!["EFGHI▲", "OPQRS║", "YZABC█", "IJKLM║", "STUVW▼", "◄█══► ",])
//         )
//     }
//
//     #[rstest]
