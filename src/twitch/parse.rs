...
mod parse_tests {
    ...
    impl TwitchIrcClient for TestTwitchIrc {
        fn display_msg(&self, _message: &str) {}

        fn listen(&mut self) {}

        fn send_privmsg(&mut self, _message: &str) {}

        fn get_badges(&self) -> Option<Vec<super::BadgeItem>> {
            None
        }
    }
